	...
	const ExportBase = EventProvider.extend("sap.ui.export.ExportBase", {
		...
		constructor: function(mSettings, mCapabilities) {
			...
			if (this._mSettings.workbook) {
				this._mSettings.workbook.hierarchyLevel = ExportUtils.getHierarchyLevel(mSettings.dataSource) || this._mSettings.workbook.hierarchyLevel;
				this._mSettings.workbook.drillState = ExportUtils.getHierarchyDrillState(mSettings.dataSource) || this._mSettings.workbook.drillState;
			}
		}
	});
