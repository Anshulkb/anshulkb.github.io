...
sap.ui.define([
	'sap/ui/base/DataType', 'sap/ui/base/ManagedObject', './Util', './ColumnWrapper', 'sap/base/util/isEmptyObject'
], function(DataType, ManagedObject, Util, ColumnWrapper, isEmptyObject) {
	"use strict";
