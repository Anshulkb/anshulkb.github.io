...
// Provides control sap.ui.comp.p13n.P13nFilterPanelBase.
sap.ui.define([
	'./P13nConditionPanel',
	'./P13nPanel',
	'sap/m/library',
	...
	'./P13nFilterPanelBaseRenderer',
	"sap/ui/core/Lib"
], function (P13nConditionPanel, P13nPanel, library, Panel, P13nFilterItem, P13nOperationsHelper, P13nFilterPanelBaseRenderer, Library) {
	"use strict";

	/**
	 * @typedef {Object} sap.ui.comp.p13n.P13nFilterPanelBase.FilterConditionOperations
	 *
	 * @property {undefined|boolean} exclude
	 * @property {string} key
	 * @property {string} keyField
	 * @property {sap.ui.comp.P13nConditionOperation} operation
	 ...
	 * @class The P13nFilterPanelBase control is used to define filter-specific settings for table personalization.
	 * @extends sap.ui.comp.p13n.P13nPanel
	 * @version 1.142.0
	 * @constructor
	 * @private
	 * @since 1.136
	 * @alias sap.ui.comp.p13n.P13nFilterPanelBase
	 */
	var P13nFilterPanelBase = P13nPanel.extend("sap.ui.comp.p13n.P13nFilterPanelBase", /** @lends sap.ui.comp.p13n.P13nFilterPanelBase.prototype */ {
		metadata: {
			...
			aggregations: {
				 ...
				 */
				filterItems: {
					type: "sap.ui.comp.p13n.P13nFilterItem",
					multiple: true,
		...
		renderer: P13nFilterPanelBaseRenderer
	});
	 ...
	 *
	 * @public
	 * @param {sap.ui.comp.p13n.P13nFilterPanelBase.FilterConditionOperations[]} aConditions the complete list of conditions
	 * @returns {this} this for chaining
	 */
	P13nFilterPanelBase.prototype.setConditions = function (aConditions) {
		var aIConditions = [];
		var aEConditions = [];
	 ...
	 *
	 * @public
	 * @returns {sap.ui.comp.p13n.P13nFilterPanelBase.FilterConditionOperations[]} array with filter conditions
	 */
	P13nFilterPanelBase.prototype.getConditions = function () {
	...
	P13nFilterPanelBase.prototype.setContainerQuery = function (bContainerQuery) {
	...
	P13nFilterPanelBase.prototype.setLayoutMode = function (sMode) {
	 ...
	 */
	P13nFilterPanelBase.prototype.validateConditions = function () {
	 ...
	 * @since 1.28
	 */
	P13nFilterPanelBase.prototype.removeInvalidConditions = function () {
	 ...
	 * @since 1.28
	 */
	P13nFilterPanelBase.prototype.removeValidationErrors = function () {
		this._oIncludeFilterPanel.removeValidationErrors();
		this._oExcludeFilterPanel.removeValidationErrors();
	};

	P13nFilterPanelBase.prototype.onBeforeNavigationFrom = function () {
		return this.validateConditions();
	};

	P13nFilterPanelBase.prototype.onAfterNavigationFrom = function () {
	 ...
	 *
	 * @public
	 * @param {sap.ui.comp.P13nConditionOperation[]} aOperation - array of operations [<code>sap.ui.comp.P13nConditionOperation.BT</code>,
	 *        <code>sap.ui.comp.P13nConditionOperation.EQ</code>]
	 * @param {string} sType - the type for which the operations are defined
	 */
	P13nFilterPanelBase.prototype.setIncludeOperations = function (aOperation, sType) {
		sType = sType || "default";
	 ...
	 * @returns {sap.ui.comp.P13nConditionOperation} array of operations [<code>sap.ui.comp.P13nConditionOperation.BT</code>,
	 *          <code>sap.ui.comp.P13nConditionOperation.EQ</code>]
	 */
	P13nFilterPanelBase.prototype.getIncludeOperations = function (sType) {
		if (this._oIncludeFilterPanel) {
	 ...
	 * @param {string} sType - the type for which the operations are defined
	 */
	P13nFilterPanelBase.prototype.setExcludeOperations = function (aOperation, sType) {
		sType = sType || "default";
	 ...
	 *          <code>sap.ui.comp.P13nConditionOperation.EQ</code>]
	 */
	P13nFilterPanelBase.prototype.getExcludeOperations = function (sType) {
		if (this._oExcludeFilterPanel) {
	 ...
	 */
	P13nFilterPanelBase.prototype.setKeyFields = function (aKeyFields, aKeyFieldsExclude) {
	...
	P13nFilterPanelBase.prototype.getKeyFields = function () {
		return this._aKeyFields;
	};

	P13nFilterPanelBase.prototype.setMaxIncludes = function (sMax) {
	...
	P13nFilterPanelBase.prototype.setMaxExcludes = function (sMax) {
	...
	P13nFilterPanelBase.prototype._updatePanel = function () {
	...
	P13nFilterPanelBase.prototype.init = function () {
		this.setType(P13nPanelType.filter);
		this.setTitle(Library.getResourceBundleFor("sap.ui.comp").getText("FILTERPANEL_TITLE"));
	...
	P13nFilterPanelBase.prototype.exit = function () {
	...
	P13nFilterPanelBase.prototype.onBeforeRendering = function () {
	 ...
	 * @private
	 */
	P13nFilterPanelBase.prototype._updateOperations = function () {
		// Include
	 ...
	 * @private
	 */
	P13nFilterPanelBase.prototype._enableEnhancedExcludeOperations = function () {
		if (this._oOperationsHelper) {
	 ...
	 * @private
	 */
	P13nFilterPanelBase.prototype._modifyFieldOperationsBasedOnMaxLength = function (oField) {
		var aOperations;
	 ...
	 * @private
	 */
	P13nFilterPanelBase.prototype._enhanceFieldOperationsWithEmpty = function (oField, bNullable, bExclude) {
		var oFilterPanel,
			aOperations;
	...
	P13nFilterPanelBase.prototype.addItem = function (oItem) {
	...
	P13nFilterPanelBase.prototype.removeItem = function (oItem) {
	...
	P13nFilterPanelBase.prototype.destroyItems = function () {
	...
	P13nFilterPanelBase.prototype.addFilterItem = function (oFilterItem) {
	...
	P13nFilterPanelBase.prototype.insertFilterItem = function (oFilterItem, iIndex) {
	...
	P13nFilterPanelBase.prototype.updateFilterItems = function (sReason) {
	...
	P13nFilterPanelBase.prototype.setMessageStrip = function (oMessageStrip) {
	...
	P13nFilterPanelBase.prototype.updateMessageStrip = function (sReason) {
	...
	P13nFilterPanelBase.prototype.removeFilterItem = function (oFilterItem) {
	...
	P13nFilterPanelBase.prototype.removeAllFilterItems = function () {
	...
	P13nFilterPanelBase.prototype.destroyFilterItems = function () {
	...
	P13nFilterPanelBase.prototype._handleDataChange = function () {
		var that = this;
	...
	P13nFilterPanelBase.prototype._notifyChange = function () {
