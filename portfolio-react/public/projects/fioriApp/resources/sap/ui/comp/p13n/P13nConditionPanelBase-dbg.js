...
// Provides control sap.ui.comp.p13n.P13nConditionPanelBase
...
sap.ui.define([
	...
	'./P13nConditionPanelBaseRenderer'
], function(
	library,
	Library,
	coreLibrary,
	...
	// shortcut for sap.ui.compButtonType
	var ButtonType = library.ButtonType;

	// shortcut for sap.ui.compToolbarDesign
	var ToolbarDesign = library.ToolbarDesign;

	// shortcut for sap.ui.core.TextAlign
	var TextAlign = coreLibrary.TextAlign;

	// shortcut for sap.ui.compOverflowToolbarPriority
	var OverflowToolbarPriority = library.OverflowToolbarPriority;

	// shortcut for sap.ui.compP13nConditionOperation
	 ...
	 * @private
	 * @since 1.136
	 * @alias sap.ui.comp.p13n.P13nConditionPanelBase
	 */
	var P13nConditionPanelBase = Control.extend("sap.ui.comp.p13n.P13nConditionPanelBase", /** @lends sap.ui.comp.p13n.P13nConditionPanelBase.prototype */ {
		metadata: {
			...
			properties: {
				 ...
				 * When the <code>P13nConditionPanelBase</code> is used on a dialog the property should be set to <code>true</code>!
				 */
				containerQuery: {
					type: "boolean",
					group: "Misc",
		...
		renderer: P13nConditionPanelBaseRenderer
	});
	 ...
	 * @public
	 */
	P13nConditionPanelBase.prototype.setConditions = function(aConditions) {
		if (!aConditions) {
			Log.error("sap.ui.compP13nConditionPanelBase : aCondition is not defined");
		}
	 ...
	 * @public
	 */
	P13nConditionPanelBase.prototype.removeAllConditions = function() {
		this._oConditionsMap = {};
		this._aConditionKeys = [];
		this._iConditions = 0;
	 ...
	 *
	 * @param {object} oCondition the new condition of type <code>{ "key": "007", "operation": sap.ui.compP13nConditionOperation.Ascending, "keyField":
	 *        "keyFieldKey", "value1": "", "value2": ""};</code>
	 * @public
	 */
	P13nConditionPanelBase.prototype.addCondition = function(oCondition) {
		if (this._bIgnoreSetConditions) {
			return;
		}
	 ...
	 * @public
	 */
	P13nConditionPanelBase.prototype.insertCondition = function(oCondition, index) {
		if (this._bIgnoreSetConditions) {
			return;
		}
		if (index !== undefined) {
	 ...
	 * @public
	 */
	P13nConditionPanelBase.prototype.removeCondition = function(vCondition) {
		this._clearConditions();
	 ...
	 *        "keyFieldKey", "value1": "", "value2": ""};</code>
	 */
	P13nConditionPanelBase.prototype._addCondition2Map = function(oCondition) {
		if (!oCondition.key) {
	...
	P13nConditionPanelBase.prototype._removeConditionFromMap = function(sKey) {
		this._iConditions--;
	 ...
	 */
	P13nConditionPanelBase.prototype.getConditions = function() {
		var oCondition;
		var aConditions = [];
	 ...
	 *
	 * @public
	 * @param {sap.ui.compP13nConditionOperation[]} aOperations array of operations <code>[sap.ui.compP13nConditionOperation.BT, sap.ui.compP13nConditionOperation.EQ]</code>
	 ...
	 *        operations.
	 */
	P13nConditionPanelBase.prototype.setOperations = function(aOperations, sType) {
		sType = sType || "default";
	...
	P13nConditionPanelBase.prototype.setValues = function(aValues, sType) {
		sType = sType || "default";
	 ...
	 *
	 * @public
	 * @param {sap.ui.compP13nConditionOperation} oOperation
	 * @param {string} sType defines the type for which this operations will be used.
	 */
	P13nConditionPanelBase.prototype.addOperation = function(oOperation, sType) {
		sType = sType || "default";
	 ...
	 */
	P13nConditionPanelBase.prototype.removeAllOperations = function(sType) {
		sType = sType || "default";
	 ...
	 * @returns {sap.ui.compP13nConditionOperation[]} array of operations
	 */
	P13nConditionPanelBase.prototype.getOperations = function(sType) {
		sType = sType || "default";
	 ...
	 */
	P13nConditionPanelBase.prototype.setKeyFields = function(aKeyFields) {
		this._aKeyFields = aKeyFields;
		this._aKeyFields.forEach(function(oKeyField) {
			P13nConditionPanelBase._createKeyFieldTypeInstance(oKeyField);
		}, this);
	 ...
	 */
	P13nConditionPanelBase.prototype.addKeyField = function(oKeyField) {
	...
	P13nConditionPanelBase._createKeyFieldTypeInstance = function(oKeyField) {
		var oConstraints;
			...
			switch (oKeyField.type) {
				...
				case "numc":
					if (!(oKeyField.formatSettings && oKeyField.formatSettings.isDigitSequence)) {
						Log.error("sap.ui.compP13nConditionPanelBase", "NUMC type support requires isDigitSequence==true!");
					...
					if (!oConstraints.maxLength) {
						Log.error("sap.ui.compP13nConditionPanelBase", "NUMC type suppport requires maxLength!");
					}
	 ...
	 * @public
	 */
	P13nConditionPanelBase.prototype.removeAllKeyFields = function() {
		this._aKeyFields = [];
	 ...
	 */
	P13nConditionPanelBase.prototype.getKeyFields = function() {
	 ...
	 */
	P13nConditionPanelBase.prototype.setAlwaysShowAddIcon = function(bEnabled) {
	 ...
	 */
	P13nConditionPanelBase.prototype.setLayoutMode = function(sLayoutMode) {
	...
	/**
	 * sets the ContainerQuery. defines if the mediaQuery or a ContainerResize will be used for layout update. When the P13nConditionPanelBase is used on
	 ...
	 * @returns {this} <code>this</code> to allow method chaining
	 */
	P13nConditionPanelBase.prototype.setContainerQuery = function(bEnabled) {
	 ...
	 */
	P13nConditionPanelBase.prototype._updateConditionFieldSpans = function(sMode) {
	 ...
	 * @private
	 */
	P13nConditionPanelBase.prototype.init = function() {
		// init some resources
	 ...
	 * @private
	 */
	P13nConditionPanelBase.prototype._createPaginatorToolbar = function() {
	 ...
	 * @private
	 */
	P13nConditionPanelBase.prototype._updatePaginatorToolbar = function() {
	 ...
	 * @private
	 */
	P13nConditionPanelBase.prototype._setToolbarElementVisibility = function(bVisible) {
	 ...
	 * @private
	 */
	P13nConditionPanelBase.prototype.exit = function() {
		this._clearConditions();
	 ...
	 * @private
	 */
	P13nConditionPanelBase.prototype._clearConditions = function() {
	 ...
	 * @private
	 */
	P13nConditionPanelBase.prototype._fillConditions = function() {
	 ...
	 * @private
	 */
	P13nConditionPanelBase.prototype._addCondition = function(oCondition) {
		var i = 0;
	...
	P13nConditionPanelBase.prototype._getMaxConditionsAsNumber = function() {
		return this.getMaxConditions() === "-1" ? 9999 : parseInt(this.getMaxConditions());
	};

	P13nConditionPanelBase.prototype.onAfterRendering = function() {
	...
	P13nConditionPanelBase.prototype._handleMediaChange = function(p) {
	...
	P13nConditionPanelBase.prototype._unregisterResizeHandler = function() {
	...
	P13nConditionPanelBase.prototype._registerResizeHandler = function() {
	 ...
	 */
	P13nConditionPanelBase.prototype._getKeyFromConditionGrid = function(oConditionGrid) {
	 ...
	 */
	P13nConditionPanelBase.prototype._createConditionKey = function() {
		var i = 0;
		var sKey;
		do {
			sKey = "condition_" + i;
	 ...
	 */
	P13nConditionPanelBase.prototype._createConditionRow = function(oTargetGrid, oConditionGridData, sKey, iPos, bUseRowFromAbove) {
		var oGrid,
			that = this;
			...
			switch (field["Control"]) {
				...
				case "ComboBox":
					if (field["ID"] === "keyField") {
						oControl = new ComboBox({ // before we used the new sap.ui.compSelect control
							width: "100%",
							...
							if (typeof vValue === "string" && oConditionGrid.oType.getName() === "sap.ui.comp.odata.type.StringDate") {
								...
								if (typeof vValue === "string" && ["String", "sap.ui.model.odata.type.String", "sap.ui.model.odata.type.Decimal"].indexOf(oConditionGrid.oType.getName()) == -1) {
									try {
										...
										Log.error("sap.ui.compP13nConditionPanelBase", "Value '" + vValue + "' does not have the expected type format for " + oConditionGrid.oType.getName() + ".parseValue()");
									}
								} else {
									oControl.setValue(oConditionGrid.oType.formatValue(vValue, "string"));
								}
	 ...
	 */
	P13nConditionPanelBase.prototype._handleRemoveCondition = function(oTargetGrid, oConditionGrid) {
	 ...
	 * @param {sap.ui.layout.Grid} oSourceConditionGrid from where the Add is triggered
         * @param {boolean} bUseRowFromAbove use the key from the row above for creating a new row
	 */
	P13nConditionPanelBase.prototype._handleAddCondition = function(oTargetGrid, oSourceConditionGrid, bUseRowFromAbove) {
	 ...
	 */
	P13nConditionPanelBase.prototype._getCurrentKeyFieldItem = function(oKeyFieldCtrl) {
	 ...
	 */
	P13nConditionPanelBase.prototype._createValueField = function(oCurrentKeyField, oFieldInfo, oConditionGrid) {
		var oControl;
		var sCtrlType;
		var that = this;
		...
		if (oCurrentKeyField && oCurrentKeyField.typeInstance) {
			...
			if (sCtrlType === "DateTimePicker" && oType.getMetadata().getName() === "sap.ui.model.odata.type.DateTime") {
				if (!(oType.oConstraints && oType.oConstraints.isDateOnly)) {
					Log.error("sap.ui.compP13nConditionPanelBase", "sap.ui.model.odata.type.DateTime without displayFormat = Date is not supported!");
							...
							if (sPastedValue) {
								...
								if (oKeyField.typeInstance) {
									...
									try {
										...
										Log.error("sap.ui.compP13nConditionPanelBase.onPaste", "not able to parse value " + sPastedValue + " with type " + oKeyField.typeInstance.getName());
										sPastedValue = "";
										oPastedValue = null;
									}
	...
	P13nConditionPanelBase.prototype._getConditions = function(oConditionsSettings) {
		return {
	 ...
	 */
	P13nConditionPanelBase.prototype._fillOperationListItems = function(oCtrl, aOperations, sType) {
	 ...
	 *
	 * @private
	 * @param {sap.ui.compComboBox} oCtrl the select control which should be filled
	 * @param {array} aItems array of keyfields
	 */
	P13nConditionPanelBase.prototype._fillKeyFieldListItems = function(oCtrl, aItems) {
		oCtrl.destroyItems();
		for (var iItem in aItems) {
			var oItem = aItems[iItem];
			oCtrl.addItem(new ListItem({
	 ...
	 */
	P13nConditionPanelBase.prototype._handleChangeOnOperationField = function(oTargetGrid, oConditionGrid) {
		this._changeOperationValueFields(oTargetGrid, oConditionGrid);
		this._changeField(oConditionGrid);
	};
	 ...
	 */
	P13nConditionPanelBase.prototype._handleSelectionChangeOnKeyField = function(oTargetGrid, oConditionGrid) {
	 ...
	 * @param {sap.ui.layout.Grid} oConditionGrid Grid which contains the KeyField control which has been changed
	 */
	P13nConditionPanelBase.prototype._handleChangeOnKeyField = function(oTargetGrid, oConditionGrid) {
	...
	P13nConditionPanelBase.prototype._createAndUpdateAllKeyFields = function() {
	 ...
	 * @param {sap.ui.layout.Grid} oConditionGrid Grid which contains the KeyField control which has been changed
	 */
	P13nConditionPanelBase.prototype._createAndUpdateValueFields = function(oTargetGrid, oConditionGrid) {
	...
	P13nConditionPanelBase.prototype._updateAllOperations = function() {
		var aConditionGrids = this._oConditionsGrid.getContent();
		aConditionGrids.forEach(function(oConditionGrid) {
	 ...
	 */
	P13nConditionPanelBase.prototype._updateOperationItems = function(oTargetGrid, oConditionGrid) {
		var oKeyField = this._getCurrentKeyFieldItem(oConditionGrid.keyField);
	 ...
	 */
	P13nConditionPanelBase.prototype._updateKeyFieldItems = function(oTargetGrid, bFillAll, bAppendLast, oIgnoreKeyField) {
	 ...
	 * @param {sap.ui.layout.Grid} oConditionGrid Grid which contains the Operation control which has been changed
	 */
	P13nConditionPanelBase.prototype._changeOperationValueFields = function(oTargetGrid, oConditionGrid) {
	 ...
	 */
	P13nConditionPanelBase.prototype._adjustValue1Span = function(oConditionGrid) {
	 ...
	 */
	P13nConditionPanelBase.prototype._getIndexOfCondition = function(oConditionGrid) {
		var iIndex = -1;
	 ...
	 *
	 */
	P13nConditionPanelBase.prototype._makeFieldValid = function(oCtrl, bValid, sMsg) {
		if (bValid) {
	 ...
	 */
	P13nConditionPanelBase.prototype._validateAndFormatFieldValue = function(oEvent) {
	...
	P13nConditionPanelBase.prototype._updateMinMaxDate = function(oConditionGrid, oValue1, oValue2) {
	 ...
	 * @param {sap.ui.layout.Grid} oConditionGrid Grid which contains the Operation control which has been changed
	 */
	P13nConditionPanelBase.prototype._changeField = function(oConditionGrid, oEvent) {
		...
		var getValuesFromField = function(oControl, oType) {
			var sValue;
			var oValue;
			if (oControl.getDateValue && !(oControl.isA("sap.ui.compTimePicker")) && oType.getName() !== "sap.ui.comp.odata.type.StringDate") {
				...
				if (oType && oType.getName() === "sap.ui.comp.odata.type.StringDate") {
					...
					try {
						...
						Log.error("sap.ui.compP13nConditionPanelBase", "not able to parse value " + sValue + " with type " + oType.getName());
						sValue = "";
					}
				}
			}
	 ...
	 */
	P13nConditionPanelBase.prototype._getValueTextFromField = function(oControl) {
		if (oControl instanceof Select) {
	 ...
	 * @private
	 */
	P13nConditionPanelBase.prototype._updateAllConditionsEnableStates = function() {
		var aConditionGrids = this._oConditionsGrid.getContent();
		aConditionGrids.forEach(function(oConditionGrid) {
			var oKeyField = this._getCurrentKeyFieldItem(oConditionGrid.keyField);
	 ...
	 */
	P13nConditionPanelBase.prototype._enableCondition = function(oConditionGrid, bEnable) {
	 ...
	 * @param {sap.ui.layout.Grid} oConditionGrid from where the remove is triggered
	 */
	P13nConditionPanelBase.prototype._removeCondition = function(oTargetGrid, oConditionGrid) {
	 ...
	 * @param {sap.ui.layout.Grid} oTargetGrid the main grid
	 */
	P13nConditionPanelBase.prototype._updateConditionButtons = function(oTargetGrid) {
		var iMaxConditions = this._getMaxConditionsAsNumber();
		var n = oTargetGrid.getContent().length;
	 ...
	 *
	 */
	P13nConditionPanelBase.prototype.validateConditions = function() {
		var that = this;
	 ...
	 * @since 1.28.0
	 */
	P13nConditionPanelBase.prototype.removeValidationErrors = function() {
	 ...
	 * @since 1.28.0
	 */
	P13nConditionPanelBase.prototype.removeInvalidConditions = function() {
	 ...
	 */
	P13nConditionPanelBase.prototype._checkCondition = function(oConditionGrid, isLast) {
		var bValid = true;
	 ...
	 *
	 * @private
	 * @param {string} sOperation the operation type sap.ui.compP13nConditionOperation
	 ...
	 */
	P13nConditionPanelBase.prototype._getFormatedConditionText = function(sOperation, sValue1, sValue2, bExclude, sKeyField, bShowIfGrouped) {
		var sConditionText = P13nConditionPanelBase.getFormatedConditionText(sOperation, sValue1, sValue2, bExclude);
		if (!sConditionText) {
			switch (sOperation) {
	...
	P13nConditionPanelBase._oConditionMap = {
		"EQ": "=$0",
		"GT": ">$0",
		"GE": ">=$0",
		"LT": "<$0",
	...
	(function() {
		...
		P13nConditionPanelBase._oConditionMap[P13nConditionOperation.Empty] = P13nConditionPanelBase._oConditionMap[P13nConditionOperation.Empty].replace("$r", _oRb.getText("CONDITIONPANEL_OPTIONEmpty"));
	})();
	 ...
	 */
	P13nConditionPanelBase._templateReplace = function(sTemplate, aValues) {
	 ...
	 */
	P13nConditionPanelBase.getFormatedConditionText = function(sOperation, sValue1, sValue2, bExclude) {
		var sConditionText = "";

		switch (sOperation) {
			case P13nConditionOperation.Empty:
				sConditionText = P13nConditionPanelBase._templateReplace(P13nConditionPanelBase._oConditionMap[sOperation], []);
				break;
			...
			case P13nConditionOperation.EndsWith:
				if (sValue1 !== "" && sValue1 !== undefined && sValue1 !== null) {
					sConditionText = P13nConditionPanelBase._templateReplace(P13nConditionPanelBase._oConditionMap[sOperation], [sValue1]);
				}
				break;
			...
			case P13nConditionOperation.BT:
				if (sValue1 !== "" && sValue1 !== undefined && sValue1 !== null) {
					if (sValue2 !== "" && sValue2 !== undefined && sValue2 !== null) {
						sConditionText = P13nConditionPanelBase._templateReplace(P13nConditionPanelBase._oConditionMap[sOperation], [sValue1, sValue2]);
					}
				}
				break;
	...
	P13nConditionPanelBase.prototype._updateLayout = function(oRangeInfo) {
		if (!this._oConditionsGrid) {
			return;
		}
	...
	P13nConditionPanelBase.prototype._onGridResize = function() {
		var w;
	...
	P13nConditionPanelBase.prototype._findConfig = function(vType, sConfigName) {
	...
	P13nConditionPanelBase.prototype._getConfig = function(sType, sConfigName) { // no vType support here, because called often
	...
	P13nConditionPanelBase.prototype._getParentType = function(sType) {
		return this._mTypes[sType];
	};

	P13nConditionPanelBase.prototype._getRelevantOperations = function (oKeyField) {
		var aOperations,
	...
	P13nConditionPanelBase.prototype._addButtons = function(oConditionGrid, oTargetGrid){
		var that = this;
	...
	P13nConditionPanelBase.prototype.getCurrentOparation = function(oConditionGridData) {
		return oConditionGridData.operation;
	};

	P13nConditionPanelBase.prototype.setSuggestCallback = function(fnSuggestCallback) {
		this._fSuggestCallback = fnSuggestCallback;
	};

	P13nConditionPanelBase.prototype._hasSecondValue = function(sOperation) {
		return sOperation === P13nConditionOperation.BT;
	};

	P13nConditionPanelBase.prototype._getSecondValueNegativeIndex = function() {
		return 1;
	};

	P13nConditionPanelBase.prototype._createConditionsFields = function() {
		return [{
			"ID": "select",
			"Label": "",
			"SpanFilter": "L1 M1 S1",
	...
	P13nConditionPanelBase.prototype._hasNoValues = function(sOperation) {
	...
	P13nConditionPanelBase.prototype._setLayoutVisible = function(oControl, bVisible) {
	...
	P13nConditionPanelBase.prototype._mTypes = {
		// basic
	...
	P13nConditionPanelBase.prototype._mOpsForType = { // defines operators for types
		"base": {
