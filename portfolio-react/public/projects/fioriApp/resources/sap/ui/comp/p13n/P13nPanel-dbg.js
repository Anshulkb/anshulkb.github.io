...
// Provides control sap.ui.comp.p13n.P13nPanel.
sap.ui.define([
	 ...
	 * @abstract
	 * @since 1.136
	 * @alias sap.ui.comp.p13n.P13nPanel
	 */
	var P13nPanel = Control.extend("sap.ui.comp.p13n.P13nPanel", /** @lends sap.ui.comp.p13n.P13nPanel.prototype */
	{
		metadata: {
			"abstract": true,
			library: "sap.ui.comp",
			interfaces: [
				"sap.ui.comp.p13n.IContent"
			],
			properties: {
				/**
			...
			aggregations: {
				 ...
				 */
				items: {
					type: "sap.ui.comp.p13n.P13nItem",
					multiple: true,
					singularName: "item",
					bindable: "bindable"
				}
	 ...
	 * control, for example {@link sap.ui.comp.P13nColumnsPanel#event:changeColumnsItems} of
