	...
	const DragDropConfig = DragDropBase.extend("sap.ui.mdc.table.DragDropConfig", /** @lends sap.ui.mdc.table.DragDropConfig.prototype */ {
		metadata: {
			...
			properties: {
				 ...
				 *
				 * <b>Note:</b> Setting this property to <code>true</code> may expose the rows of the table in other <code>DropInfo</code> event
				 * parameters. In this case, only the binding context of the row is allowed to be used. Internal controls and their types are
			...
			events: {
				/**
				 * This event is fired when the user starts dragging a table row, if the <code>draggable</code> property is set to
				 * <code>true<code>.
				 */
				dragStart: {
