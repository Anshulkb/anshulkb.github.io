sap.ui.define(
  ...
  function (Control, RatingIndicator, Label, Button) {
    ...
    return Control.extend("ui5.quickstart.control.ProductRating", {
      metadata: {
        properties: {
          value: {
            type: "float",
      ...
      reset() {
        const oResourceModel = this.getModel("i18n").getResourceBundle();
        this.setValue(0);
        this.getAggregation("_label").setDesign("Standard");
        this.getAggregation("_rating").setEnabled(true);
        this.getAggregation("_label").setText(
          oResourceModel.getText("productRatingLabelInitial")
        );
